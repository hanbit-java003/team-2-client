...
INSERT INTO `area` VALUES ('dobonggu','도봉구'),('dongdaemungu','동대문구'),('dongjakgu','동작구'),('eunpyeonggu','은평구'),('gangbukgu','강북구'),('gangdonggu','강동구'),('gangnamgu','강남구'),('gangseogu','강서구'),('geumcheongu','금천구'),('gurogu','구로구'),('gwanakgu','관악구'),('gwangjingu','광진구'),('jongnogu','종로구'),('junggu','중구'),('jungnanggu','중랑구'),('mapogu','마포구'),('nowongu','노원구'),('seochogu','서초구'),('seodaemungu','서대문구'),('seongbukgu','성북구'),('songpagu','송파구'),('sungdonggu','성동구'),('yangcheongu','양천구'),('Yeongdeungpogu','영등포구'),('yongsangu','용산구');
...
-- Dump completed on 2017-11-28 15:17:09
